...
def build_combined_record(
    ...
    *,
    ...
    return CombinedInteractionRecord(
        ...
        ticket_via_channel=_resolved_ticket_via_channel(detail_ticket),
...
def _resolved_ticket_via_channel(ticket: ZendeskTicketRow | None) -> str | None:
    if ticket is None:
        return None
    tags = list(ticket.tags) if isinstance(ticket.tags, list) else []
    return resolve_ticket_via_channel(tags=tags, raw_via_channel=ticket.via_channel)
